...
describe('Session', function()
  ...
  before_each(function()
    ...
    msgpack_stream = MsgpackStream.new(proc_stream)
    msgpack_rpc_stream = MsgpackRpcStream.new(msgpack_stream)
    session = Session.new(msgpack_rpc_stream)
  end)
...
describe('stdio', function()
  it('sends and receive data through stdout/stdin', function()
    ...
    local msgpack_stream = MsgpackStream.new(proc_stream)
